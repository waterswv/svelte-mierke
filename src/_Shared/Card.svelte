<script>
  export let title = `The Coldest Sunset`
  export let content = `Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus
      quia, nulla! Maiores et perferendis eaque, exercitationem praesentium
      nihil.`
    export let tags = ['photography', 'blogger', 'travel', 'winter']
</script>
<!--
        @component 
        Title: string <br />
...
<!-- THE DROPDOWN AND BUTTONS FROM PAGE HEADING  -->
